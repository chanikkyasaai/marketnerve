...
test("home model exposes ranked signals and health data", () => {
...
test("portfolio model computes positive gain", () => {
...
test("story arc lookup falls back gracefully", () => {
...
test("portfolio analysis exposes overlap matrix", () => {
...
test("local portfolio reasoning returns grounded text", () => {
